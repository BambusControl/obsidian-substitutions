...
import {ActionableRegexSwap} from "../../libraries/types/savedata/actionable";
...
export class UserFacingRegexSwapSetting {
    ...
    get swapDef(): ActionableRegexSwap {
